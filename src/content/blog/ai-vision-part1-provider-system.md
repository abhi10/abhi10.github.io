...
**Next:** [Part 2 - Manual→Automatic Evolution](/blog/ai-vision-part2-manual-to-automatic) covers why we started with a manual `/ai-tag` endpoint (Phase 5) before going automatic with Celery (Phase 6).
...
**This Series:**
- [Part 2 - Manual→Automatic Evolution](/blog/ai-vision-part2-manual-to-automatic)
